...
Generates professional outreach pitches / website messages using OpenAI.

NOTE: LinkedIn lead classification lives in the standalone Hyperagent engine
(backend/ha/classifier.py), NOT here. This module only powers on-demand
