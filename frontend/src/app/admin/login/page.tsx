...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-navy text-ice font-sans flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-cyan-300 mb-4">
        ...
        <form onSubmit={handleSubmit} className="glass-card-premium rounded-2xl p-8 space-y-4">
          <div>
            ...
            <input
              ...
              autoFocus
              className="w-full rounded-xl bg-bg-elevated border border-primary/20 px-4 py-3 text-offwhite placeholder:text-text-muted/60 outline-none focus:border-cyan-300/50 focus:ring-2 focus:ring-cyan-300/20 transition-all"
            />
          </div>
          {error && (
