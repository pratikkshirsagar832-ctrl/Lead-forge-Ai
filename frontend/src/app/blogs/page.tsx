  ...
  return (
    <div className="min-h-screen bg-navy text-ice font-sans">
      <div className="container mx-auto px-6 pt-28 pb-16 max-w-4xl">
        <p className="text-xs font-semibold uppercase tracking-widest text-cyan-400 mb-2">Blog</p>
        ...
        {posts.length === 0 ? (
          <div className="glass-card rounded-2xl p-10 text-center">
            <p className="text-text-secondary">New articles are on the way. Check back soon.</p>
          </div>
        ) : (
          <div className="space-y-6">
            {posts.map((post) => (
              <Link
                ...
                className="block group glass-card-premium rounded-2xl p-6 md:p-8 transition-all duration-300 hover:border-secondary/30"
              >
