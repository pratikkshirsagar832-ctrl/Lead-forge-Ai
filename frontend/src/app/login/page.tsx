      ...
      <GlassCard className="w-full max-w-md p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-steel/15 rounded-xl p-2 mb-4">
            <Image src="/hyperclients-icon.png" alt="Hyperclients" width={48} height={48} className="object-contain" />
          </div>
        ...
        <form onSubmit={handleEmailAuth} method="post" action="#" className="space-y-4">
          <div>
          ...
          <LoadingButton fullWidth type="submit" isLoading={isLoading} disabled={!hydrated}>
