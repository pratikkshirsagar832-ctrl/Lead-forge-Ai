...
/** The interactive checker: URL form + audit results (client-side). */
    ...
    <div>
        ...
        {error && (
          <motion.div
            ...
            className="flex items-start gap-3 glass-card rounded-xl px-5 py-4 border-rose/30 mt-6"
          >
        ...
        {result && gs && (
          <motion.div
            ...
            className="glass-card-premium rounded-2xl overflow-hidden mt-8"
          >
