 ...
 * display headings unmask character-by-character and the ASCII hands glide in
 * from the edges.
 *
 * Self-contained, prop-driven React component. No global smooth-scroll or
 * SplitText plugin required — the reveal is driven by an IntersectionObserver
...
export interface AnimatedFooterProps {
   ...
   * plays in (`true`) / out (`false`) to match this value.
   */
  revealed?: boolean;
